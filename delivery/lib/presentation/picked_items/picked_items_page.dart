...
class PickedItemsPage extends ConsumerWidget {
  const PickedItemsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final orderItemState = ref.watch(pickedItemProvider);

    Future<void> _refreshProducts() async {
     
      ref.read(pickedItemProvider.notifier).getAllPickedItems();
    }
    ...
    return Scaffold(
      ...
      body: orderItemState.maybeWhen(
        ...
        pickedItemsLoaded: (orderItems) => Column(
          children: [
            Card(
