...
class DeliveryItemPage extends ConsumerWidget {
  const DeliveryItemPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final deliveryItemState = ref.watch(deliveryItemProvider);

    Future<void> _refreshProducts() async {
     
      ref.read(deliveryItemProvider.notifier).getAllDeliveryItem();
    }
    ...
    return Scaffold(
      ...
      body: deliveryItemState.maybeWhen(
        initial: () => const CircularProgressIndicator(),
        loadInProgress: () => const LinearProgressIndicator(),
        loadSuccess: (deliveryItems) => Column(
          children: [
            Card(
              ...
              child: RefreshIndicator(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        AutoRouter.of(context).push(DeliveryItemViewRoute(
