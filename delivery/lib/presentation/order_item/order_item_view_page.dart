...
class OrderItemViewPage extends ConsumerStatefulWidget {
  final int productId;
  final int orderItemId;

  const OrderItemViewPage(
...
class _OrderItemViewPageState extends ConsumerState<OrderItemViewPage> {
                    ...
                    onPressed: () async {
                      final result = await showDialog<bool>(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: const Text(
                              "Are you sure to pick up this product?"),
                          actions: <Widget>[
                            TextButton(
                      ...
                      if (result == true) {
                        ref
                            ...
                            .pickupProduct(widget.orderItemId);
                  ...
                  child: CustomElevatedButton(
                    onPressed: () async {
                      AutoRouter.of(context).push(
                          ProductRejectRoute(productId: widget.orderItemId));
                    },
                    text: 'Reject',
                  ),
                ),
