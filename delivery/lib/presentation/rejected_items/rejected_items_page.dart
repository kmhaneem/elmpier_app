...
class RejectedItemPage extends ConsumerWidget {
  const RejectedItemPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final orderItemState = ref.watch(rejectedItemProvider);

    Future<void> _refreshProducts() async {
    
      ref.read(rejectedItemProvider.notifier).getAllRejectedItems();
    }
    ...
    return Scaffold(
      ...
      body: orderItemState.maybeWhen(
        ...
        rejectedItemsLoaded: (orderItems) => Column(
          children: [
            Card(
