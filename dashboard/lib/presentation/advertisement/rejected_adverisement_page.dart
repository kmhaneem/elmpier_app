...
class RejectedAdvertisementPage extends ConsumerWidget {
  const RejectedAdvertisementPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final rejectedAdvertisementsState =
        ref.watch(rejectedAdvertisementProvider);

    return Scaffold(
      appBar: AppBar(
        title: Text('Rejected Advertisement'),
      ...
      body: Padding(
        ...
        child: rejectedAdvertisementsState.maybeWhen(
          initial: () => Container(),
          loadInProgress: () => Center(child: CircularProgressIndicator()),
          loadRejectedAdvertisementsSuccess: (products) => ListView.builder(
