    ...
    return Positioned.fill(
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          double firstDotPosition =
              MediaQuery.of(context).size.width * (0.33 * val);
          double thirdDotPosition =
              MediaQuery.of(context).size.width * (0.66 * (1 - val));
          double secondDotSize = 10 + (5 * (1 - val));
            ...
            child: Row(
              ...
              children: [
                ...
                Transform.translate(
                  offset: Offset(0, 0),
                  child: Dot(
                      opacity: 1.0, color: Colors.orange, size: secondDotSize),
                ),
                Transform.translate(
