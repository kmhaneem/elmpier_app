...
class PendingProductViewPage extends ConsumerStatefulWidget {
  final Product product;

  PendingProductViewPage({Key? key, required this.product}) : super(key: key);

  @override
  _PendingProductViewPageState createState() => _PendingProductViewPageState();
}

class _PendingProductViewPageState
    extends ConsumerState<PendingProductViewPage> {
                      ...
                      showConfirmationDialog(
                        ...
                        onConfirm: () {
                          ref
                              ...
                              .approveProductUpdated(widget.product.id);
                        },
                      );
                    },
                    ...
                    onPressed: () async {
                      showConfirmationDialog(
                        ...
                        onConfirm: () {
                          ref
                              .read(allProductProvider.notifier)
                              .rejectProductUpdated(widget.product.id);
                        },
                      );
                    },
                    style: ElevatedButton.styleFrom(
