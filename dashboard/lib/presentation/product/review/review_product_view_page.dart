...
class ReviewProductViewPage extends ConsumerStatefulWidget {
  final Product product;

  ReviewProductViewPage({Key? key, required this.product}) : super(key: key);

  @override
  _ReviewProductViewPageState createState() => _ReviewProductViewPageState();
}

class _ReviewProductViewPageState extends ConsumerState<ReviewProductViewPage> {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ref
                        .read(productStatusProvider.notifier)
                        .productDecline(widget.product.id);
                    ref.refresh(productProvider);
                    AutoRouter.of(context).replace(ReviewProductRoute());
                  },
                  style: ButtonStyle(
