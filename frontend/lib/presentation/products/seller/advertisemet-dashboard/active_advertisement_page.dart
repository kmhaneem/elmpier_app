...
class ActiveAdvertisementPage extends ConsumerWidget {
  const ActiveAdvertisementPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final productState = ref.watch(activeAdvertisementProvider);

    

    return Scaffold(
      appBar: AppBar(
        title: Text('Active Advertisement'),
              ...
              return InkWell(
                onTap: () {
                  AutoRouter.of(context).push(
                      SellerAdvertisementViewRoute(advertisement: product));
                },
                child: Card(
                  elevation: 1,
